...
public class SpideredUtil {
    private static final Logger LOG = LoggerFactory.getLogger(SpideredUtil.class);
    ...
    public void saveSong(Song song) {
        try {
            ...
            LOG.error("operate song error. new song=" + JSON.toJSONString(song), e);
        }
    }
    ...
    public void saveSinger(Singer singer) {
        try {
            ...
            LOG.error("operate singer error. new singer=" + JSON.toJSONString(singer), e);
        }
    }
    ...
    public void saveSubject(Subject subject) {
        try {
            ...
            LOG.error("operate subject error. new subject=" + JSON.toJSONString(subject), e);
        }
    }
    ...
    public void saveUser(User user) {
        try {
            ...
            LOG.error("operate subject error. new subject=" + JSON.toJSONString(user), e);
        }
    }

    public Subject buildSubject(Map sourceData,Subject subject) {
        if(sourceDataIsNull(sourceData)){
            LOG.info("sourceDataIsNull");
            return subject;
        }
