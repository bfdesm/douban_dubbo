...
public class SingerControl {
    ...
    @Autowired
    private KafkaTemplate<String, Singer> kafkaSingerTemplate;
    ...
    public String myMhz(Model model) {
        ...
        kafkaPageViewTemplate.send("pageView", new PageView("userguide", new Date()));
        return "userguide";
    }
    ...
    public String getSingerName(@RequestParam("singerId")String singerId){
        ...
        kafkaSingerTemplate.send("singerView", singer);
